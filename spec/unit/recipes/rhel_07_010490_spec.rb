...
# Check:
#
# Check to see if an encrypted root password is set. On systems that use UEFI, use the following command:# # # grep -i password /boot/efi/EFI/redhat/grub.cfg# password_pbkdf2 superusers-account password-hash# # If the root password entry does not begin with "password_pbkdf2", this is a finding.#
#
######
#
# Fix:
