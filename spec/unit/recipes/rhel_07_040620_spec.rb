...
# Fix:
#
# Set the system to the required kernel parameter by adding the following line to "/etc/sysctl.conf" (or modify the line to have the required value):# # net.ipv4.conf.default.accept_source_route = 0#
#
######

require 'spec_helper'

describe '::rhel_07_040620' do
